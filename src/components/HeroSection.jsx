...
//             console.warn("No active courses available from database");
//           }
//         } else {
//           console.error(
...
//     e.preventDefault();
//     try {
//       // FIXED: Format phone number correctly for Indian validation
//       // Backend expects 10 digits only (no country code, no dashes)
