    ...
    <div className="testimonial-container">
      <div className="testimonial-grid">
        ...
        <div className="testimonial-content">
          ...
          <div className="testimonial-arrow-buttons">
            <button
              className="testimonial-arrow-button testimonial-prev-button"
              onClick={handlePrev}
              style={{
            ...
            <button
              className="testimonial-arrow-button testimonial-next-button"
              onClick={handleNext}
              style={{
