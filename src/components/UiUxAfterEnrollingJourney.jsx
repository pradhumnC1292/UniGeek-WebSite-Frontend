...
const UiUxAfterEnrollingJourney = () => {
  return (
    <section className="AEJ-section">
      <div className="titile-div">
        ...
        <p>
          ...
          Designer Ready to Thrive in the Tech Industry
        </p>
      </div>
        ...
        <div id="cssportal-grid">
          <div id="div1">
            ...
            <div className="card-title-div">
              ...
              <p>
                Begin your journey by learning the basics of designing, laying a
                strong foundation for all that follows
              </p>
            </div>
          </div>
          <div id="div2">
          ...
          <div id="div4">
            ...
            <div className="card-title-div">
              ...
              <p>
                ...
                designs that mirror industry demands.
              </p>
            </div>
          </div>
          <div id="div5">
...
export default UiUxAfterEnrollingJourney;
